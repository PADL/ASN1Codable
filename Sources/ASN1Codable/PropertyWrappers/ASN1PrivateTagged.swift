...
@propertyWrapper
public struct ASN1PrivateTagged <Tag, Tagging, Value>: Codable, ASN1TaggedWrappedValue where Tag: ASN1TagNumberRepresentable, Tagging: ASN1TaggingRepresentable, Value: Codable {
    ...
    public static var metadata: ASN1Metadata {
        return ASN1Metadata(tag: .privateTag(tagNumber.tagNo), tagging: Tagging.tagging)
    }
}
...
extension ASN1PrivateTaggedType {
    public static var metadata: ASN1Metadata {
        return ASN1Metadata(tag: .privateTag(self.tagNumber))
    }
}
