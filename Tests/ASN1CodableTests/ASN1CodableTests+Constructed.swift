...
extension ASN1CodableTests {
    ...
    func test_encode_SET_PersonnelRecord() {
        ...
        self.test_encode(PersonnelRecord(name: Data([0x44, 0x61, 0x76, 0x79, 0x20, 0x4A, 0x6F, 0x6E, 0x65, 0x73]),
                                         location: 0,
                                         age: 44),
                         encodedAs: Data([0x31, 0x12, 0x80, 0x0A, 0x44, 0x61, 0x76, 0x79, 0x20, 0x4A, 0x6F, 0x6E, 0x65, 0x73,
                                          0x81, 0x01, 0x00, 0x82, 0x01, 0x2c]),
